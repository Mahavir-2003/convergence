...
const Collages = () => {
  return (
    <div className='w-full'>
        ...
        <h1 className='text-4xl sm:text-5xl md:text-8xl font-Anurati text-amber-300 w-full text-center pt-[50px]'>Our Collages</h1>
        ...
        <Marquee speed={100} className=' pb-[50px]'>
            {
                collageData.map((collageImg, index) => {
                    return (
                        <img key={index} src={collageImg} alt="sponsor" className='mx-10 aspect-auto max-h-[70px] md:max-h-[150px]'/>
                    )
                })
            }
        </Marquee>
