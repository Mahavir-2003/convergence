...
const Contact = () => {
    return (
        <div className='bg-[#111] w-full'>
            <div className=' pb-[150px] w-full flex justify-center items-center flex-col '>
                <h1 className='text-3xl sm:text-4xl md:text-7xl mb-3 font-Osiris text-white text-center'>When<span className='text-blue-500'>&nbsp; Imagination</span></h1>
                ...
                <div className=' w-full lg:w-[80%] mb-[50px]'>
                    <div className='w-full justify-around items-center md:items-start text-white flex flex-col md:flex-row gap-y-8 text-center px-20'>
                        <div>
                            ...
                            <p className='pb-2 md:max-w-[250px] font-normal text-lg opacity-80 hover:opacity-100 duration-100'><a href="https://uvpce.guni.ac.in/" target='_blank' rel="noreferrer">U.V. Patel College Of Engineering</a></p>
